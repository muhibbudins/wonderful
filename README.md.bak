...
In this project i use [Gulp]() for compile SASS/SCSS to CSS so for first setup you can following this step. * Note : If you already using Gulp you can skip this step and go to [Clone & Install]().

### Installing Node JS

### Installing Gulp

Installing Gulp using Node JS, run `npm i -g gulp` after that check Gulp already installed or not using check Gulp version run `gulp -v`
